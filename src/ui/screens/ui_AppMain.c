...
void ui_AppMain_screen_init(void)
{
    ...
    ui_Button1 = lv_btn_create(ui_AppMain);
    lv_obj_set_width(ui_Button1, 242);
    lv_obj_set_height(ui_Button1, 73);
    lv_obj_set_x(ui_Button1, -233);
    ...
    lv_label_set_text(ui_Label1, "UART Analyzer");
